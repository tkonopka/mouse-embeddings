...
.emb <- model_umap_embedding$vector[label=="model" & id %in% model_ids$phen_gt_0]
...
.emb2 <- model_umap_embedding$text_concise_diff0[label=="model" & id %in% model_ids$phen_gt_0]
