...
```{r supfig.models.covariates, eval=TRUE, echo=FALSE, fig.width=6.2, fig.height=7.6, fig.cap="\\textbf{Mouse model covariates.} All panels show embeddings of mouse models based on non-binary vectors of phenotypes. Panels differ by stratification strategy: \\textbf{(A)} phenotyping source; \\textbf{(B)} zygosity of gene knock-out; \\textbf{(C)} number of registered phenotypes; \\textbf{(D)} animal genetic background; "}
